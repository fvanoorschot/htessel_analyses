...
from f_significance_calculation_rmse import *
...
# tp = 'fullfield'
# reps=1000
# run_significance_rmse_e(exp_name1, exp_name2, tp, start_year, end_year, ref_data, fol, reps,dt) #save quantiles
...
# season='jja'
# run_significance_seasons_rmse_e(exp_name1, exp_name2, tp, start_year, end_year, ref_data, fol, reps,season,dt) #save quantiles
...
run_significance_SM_esa_rmse(exp_name1, exp_name2, tp, start_year, end_year, fol, reps,layer,dt,th)

# SM std anomalies seasons
start_year = '1999'
end_year = '2018'
exp_name1 = 'exp5'
exp_name2 = 'exp6'
...
season='djf'
run_significance_SM_esa_seasons_rmse(exp_name1, exp_name2, tp, start_year, end_year, fol, reps,layer,season,dt,th)
